<?php $tituloPagina = "Bake & Go | 404 Não Encontrado" ?>
...
<main class="error">
  <div class="container d-flex h-100 align-items-center">
    ...
    <img class="img-fluid error-img" src="./assets/img/404-pao.png" alt="">
      <h2 class="mx-auto my-0">Desculpe!</h2>
      <h2 class="mx-auto mb-5"><br> Parece que não encontramos o que você procura.</h2>
      <div class="col-12 mt-5 mb-3 text-center">
        <a href="./index.php" class="btn btn-primary">VOLTE A PÁGINA INICIAL</a>
      </div>
      </div>
    </div>
</main>