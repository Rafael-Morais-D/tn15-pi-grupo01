<header>
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="index.php"><img src="./assets/img/bakeandgo_logo_02_black.svg" alt="Logo Bake & Go" width="270px"></a>
        ...
        <div class="modal fade" id="btnLogin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                    ...
                    <div class="modal-footer">
                        <p class="pt-3">Novo por aqui? <a href="cadastro.php">Cadastre-se agora!</a></p>
