<?php $tituloPagina = "Bake & Go | Produtos"; ?>
...
<section>
  ...
  <section class='paes'>
    ...
    <div class="col-lg-10 mx-auto col-12 text-left mb-3">
        ...
        <div class="card-deck">
          <div class="card">
            <img class="card-img-top" src="./assets/produtos/pao/paoitaliano.png" alt="Card image cap">
            <div class="card-body">
            <span class="float-right">R$12</span>
          ...
          <div class="card">
            <img class="card-img-top" src="./assets/produtos/pao/bolo.png" alt="Card image cap">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="./assets/produtos/pao/paodequeijo.jpg" alt="Card image cap">
            <div class="card-body">
            <span class="float-right">R$5</span>
